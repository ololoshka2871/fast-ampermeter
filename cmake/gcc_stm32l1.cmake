...
SET(CMAKE_CXX_FLAGS "-mthumb -fno-builtin -mcpu=cortex-m3 -Wall -std=c++${CPP_STD} -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize" CACHE INTERNAL "cxx compiler flags")
...
MACRO(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE)
    ...
    ELSEIF(STM32_CHIP STREQUAL "STM32L100RB")
        SET(RAM "10K")
    ELSEIF(STM32_CHIP STREQUAL "STM32L151CB")
        SET(RAM "16K")
